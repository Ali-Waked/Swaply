...
<template>
  <div class="h-[58px] mb-8">
    <div
      ref="buttonGroup"
      class="flex items-center justify-center shoadow-lg bg-white rounded-lg overflow-hidden space-x-4 dark:bg-gray-800 shadow-md flex-1 p-0 fixed top-[12px] left-0 right-0 z-[10000000] mx-auto w-fit"
    >
