  ...
  <div class="border rounded-xl p-6 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900" v-if="user">
    <div class="info flex items-center gap-4 mb-7">
      ...
      <div>
        <span class="font-[500]">
          ...
          <p class="degree text-gray-700 dark:text-gray-300 text-[12px] font-[500] mt-1">
            {{ joinedAt }}
          </p>
    ...
    <div class="degree-ability mt-4">
      <div class="flex items-center justify-between mb-2">
        <span class="font-[400] text-gray-700 dark:text-gray-300 text-[13px]">درجة الموثوقية</span>
        <span class="text-blue-950 dark:text-white font-[400] text-[13px]">87%</span>
      </div>
    ...
    <div class="flex gap-4 items-center justify-between mt-4">
      <div class="box flex-1 text-center bg-green-100 dark:bg-green-700/60 p-4 rounded-lg">
        <span class="font-[600] text-[32px] text-green-600 dark:text-green-300">11</span>
