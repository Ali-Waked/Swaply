...
<template>
  <nav class="h-[76px] bg-gray-100 dark:bg-gray-900 shadow">
    <div
      class="flex justify-between items-center h-full container mx-auto px-2"
    >
  ...
  <aside class="relative">
    <ul
      ref="links-side"
      class="bg-white dark:bg-gray-800 fixed w-[250px] top-0 bottom-0 z-20 transition-all duration-300"
      :class="{
        'right-0': sideOpen,
        '-right-full': !sideOpen,
      }"
    ...
    <div
      class="overlay fixed top-0 left-0 h-screen w-screen z-10"
      :class="{
