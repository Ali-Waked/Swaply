    ...
    >
      ...
      <div class="mb-4">
        <input
          ...
          maxlength="6"
          class="focus:border-gray-500 focus:ring-gray-500 rounded-md bg-gray-100 dark:bg-gray-700 dark:text-white block w-full text-center text-xl tracking-[1rem] placeholder:text-[14px] placeholder:font-[400] dark:placeholder-gray-400"
          :class="{
